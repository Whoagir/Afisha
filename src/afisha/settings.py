...
# gRPC настройки
GRPC_EMAIL_SERVER = os.environ.get("GRPC_EMAIL_SERVER", "localhost:50051")
DEFAULT_EMAIL_SENDER = os.environ.get("DEFAULT_EMAIL_SENDER", "noreply@example.com")
